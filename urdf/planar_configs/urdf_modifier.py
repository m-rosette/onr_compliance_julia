...
tree = ET.parse('urdf/arm_vehicle.urdf')
root = tree.getroot()
...
if run_urdf_gen == True:
    ...
    for count, config in enumerate(configs):
        ...
        for joint in root.iter('joint'):
            try:
                ...
                if joint.attrib['name'] == joint_names[0]:
                    ...
                    new_orient = origin.attrib['rpy'] = f'0 0 {config[joint_num]}' # Subtract by pi to match the Julia orientation
        ...
        tree.write(f'urdf/new_urdf_configs_disc_100/bravo_config_{count}.urdf', xml_declaration=True)
